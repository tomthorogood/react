...
const Group = ({
  ...
  return /*#__PURE__*/React__default.default.createElement(Box, _extends({
    as: "li",
    sx: sxProp
  }, props), /*#__PURE__*/React__default.default.createElement(index.ActionList.Divider, {
    as: "div",
    sx: {
      '&:first-child': {
        display: 'none'
  ...
  }), title && /*#__PURE__*/React__default.default.createElement(index.ActionList.Heading, {
    title: title
  }), /*#__PURE__*/React__default.default.createElement(Box, {
    as: "ul",
    sx: {
