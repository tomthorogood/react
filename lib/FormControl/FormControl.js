...
const FormControlContext = /*#__PURE__*/React__default.default.createContext({});
const FormControl = /*#__PURE__*/React__default.default.forwardRef(({
  ...
  return /*#__PURE__*/React__default.default.createElement(FormControlContext.Provider, {
    value: {
      captionId,
      disabled,
      id,
  ...
  }, InputComponent.props)), childrenWithoutSlots.filter(child => /*#__PURE__*/React__default.default.isValidElement(child) && !expectedInputComponents.some(inputComponent => child.type === inputComponent)), slots.validation ? /*#__PURE__*/React__default.default.createElement(_ValidationAnimationContainer, {
    show: true
