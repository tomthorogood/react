...
const CheckboxGroup = ({
  ...
  const formControlComponentChildren = React__default.default.Children.toArray(children).filter(child => /*#__PURE__*/React__default.default.isValidElement(child) && child.type === FormControl.default).map(formControlComponent => /*#__PURE__*/React__default.default.isValidElement(formControlComponent) ? formControlComponent.props.children : []).flat();
